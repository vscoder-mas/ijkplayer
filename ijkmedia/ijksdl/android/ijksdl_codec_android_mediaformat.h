...
typedef struct SDL_AMediaFormat {
    ...
    bool (*func_getInt32)(SDL_AMediaFormat* aformat, const char* name,
                          int32_t* out);
    void (*func_setInt32)(SDL_AMediaFormat* aformat, const char* name,
                          int32_t value);
    void (*func_setBuffer)(SDL_AMediaFormat* aformat, const char* name,
...
bool SDL_AMediaFormat_getInt32(SDL_AMediaFormat* aformat, const char* name,
                               int32_t* out);
void SDL_AMediaFormat_setInt32(SDL_AMediaFormat* aformat, const char* name,
                               int32_t value);

void SDL_AMediaFormat_setBuffer(SDL_AMediaFormat* aformat, const char* name,
                                void* data, size_t size);
