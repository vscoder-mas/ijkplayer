...
#define SDL_AMIME_VIDEO_VP8 \
    "video/x-vnd.on2.vp8"  //- VP8 video (i.e. video in .webm)
#define SDL_AMIME_VIDEO_VP9 \
...
#define SDL_AMIME_AUDIO_RAW_AAC \
    "audio/mp4a-latm"  //- AAC audio (note, this is raw AAC packets, not
                       //packaged in LATM!)
...
enum {
    ...
    _AMEDIACODEC__OMX_INTEL_COLOR_FormatYUV420PackedSemiPlanar_Tiled =
        0x7FA00F00,

    // from hardware qcom
    _AMEDIACODEC__OMX_QCOM_COLOR_FormatYVU420SemiPlanar = 0x7FA30C00,
    _AMEDIACODEC__OMX_QCOM_COLOR_FormatYVU420PackedSemiPlanar32m4ka =
        0x7FA30C01,
    _AMEDIACODEC__OMX_QCOM_COLOR_FormatYUV420PackedSemiPlanar16m2ka =
        0x7FA30C02,
    _AMEDIACODEC__OMX_QCOM_COLOR_FormatYUV420PackedSemiPlanar64x32Tile2m8ka =
        0x7FA30C03,
    _AMEDIACODEC__OMX_QCOM_COLOR_FORMATYUV420PackedSemiPlanar32m = 0x7FA30C04,
    _AMEDIACODEC__OMX_QCOM_COLOR_FORMATYUV420PackedSemiPlanar32mMultiView =
        0x7FA30C05,
