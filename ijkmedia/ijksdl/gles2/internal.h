...
typedef struct IJK_GLES2_Renderer {
    ...
    GLsizei (*func_getBufferWidth)(IJK_GLES2_Renderer *renderer,
                                   SDL_VoutOverlay *overlay);
    GLboolean (*func_uploadTexture)(IJK_GLES2_Renderer *renderer,
                                    SDL_VoutOverlay *overlay);
...
void IJK_GLES2_loadOrtho(IJK_GLES_Matrix *matrix, GLfloat left, GLfloat right,
...
IJK_GLES2_Renderer *IJK_GLES2_Renderer_create_base(
...
IJK_GLES2_Renderer *IJK_GLES2_Renderer_create_yuv420sp_vtb(
    SDL_VoutOverlay *overlay);
