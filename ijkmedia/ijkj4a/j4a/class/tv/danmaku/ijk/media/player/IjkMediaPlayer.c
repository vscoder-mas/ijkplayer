...
jlong J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaPlayer__get(
...
jlong J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaPlayer__get__catchAll(
    JNIEnv *env, jobject thiz) {
    jlong ret_value =
        J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaPlayer__get(
            env, thiz);
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaPlayer__set(
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaPlayer__set__catchAll(
    JNIEnv *env, jobject thiz, jlong value) {
...
jlong J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaDataSource__get(
    JNIEnv *env, jobject thiz) {
    return (*env)->GetLongField(
        env, thiz,
        class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
...
jlong J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaDataSource__get__catchAll(
    JNIEnv *env, jobject thiz) {
    jlong ret_value =
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaDataSource__set(
    JNIEnv *env, jobject thiz, jlong value) {
    (*env)->SetLongField(env, thiz,
                         class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
                             .field_mNativeMediaDataSource,
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeMediaDataSource__set__catchAll(
    JNIEnv *env, jobject thiz, jlong value) {
...
jlong J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeAndroidIO__get(
    JNIEnv *env, jobject thiz) {
    return (*env)->GetLongField(
        env, thiz,
        class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
...
jlong J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeAndroidIO__get__catchAll(
    JNIEnv *env, jobject thiz) {
    jlong ret_value =
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeAndroidIO__set(
    JNIEnv *env, jobject thiz, jlong value) {
    (*env)->SetLongField(env, thiz,
                         class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
                             .field_mNativeAndroidIO,
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__mNativeAndroidIO__set__catchAll(
    JNIEnv *env, jobject thiz, jlong value) {
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postEventFromNative(
    JNIEnv *env, jobject weakThiz, jint what, jint arg1, jint arg2,
    jobject obj) {
    (*env)->CallStaticVoidMethod(
        env, class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id,
        class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
...
void J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postEventFromNative__catchAll(
    ...
    J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__postEventFromNative(
        env, weakThiz, what, arg1, arg2, obj);
    J4A_ExceptionCheck__catchAll(env);
}

jstring J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec(
    JNIEnv *env, jobject weakThiz, jstring mimeType, jint profile, jint level) {
...
jstring
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__asGlobalRef__catchAll(
    JNIEnv *env, jobject weakThiz, jstring mimeType, jint profile, jint level) {
    jstring ret_object = NULL;
    jstring local_object =
        J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__catchAll(
            env, weakThiz, mimeType, profile, level);
...
const char *
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__asCBuffer(
    JNIEnv *env, jobject weakThiz, jstring mimeType, jint profile, jint level,
...
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__withCString(
    JNIEnv *env, jobject weakThiz, const char *mimeType_cstr__, jint profile,
    jint level) {
    jstring ret_object = NULL;
    jstring mimeType = NULL;

    mimeType = (*env)->NewStringUTF(env, mimeType_cstr__);
    if (J4A_ExceptionCheck__throwAny(env) || !mimeType) goto fail;

    ret_object = J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec(
        env, weakThiz, mimeType, profile, level);
...
jstring
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__withCString__catchAll(
    JNIEnv *env, jobject weakThiz, const char *mimeType_cstr__, jint profile,
    jint level) {
    jstring ret_object = NULL;
    jstring mimeType = NULL;
    ...
    mimeType = (*env)->NewStringUTF(env, mimeType_cstr__);
    if (J4A_ExceptionCheck__catchAll(env) || !mimeType) goto fail;
...
const char *
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__withCString__asCBuffer(
    JNIEnv *env, jobject weakThiz, const char *mimeType_cstr__, jint profile,
    jint level, char *out_buf, int out_len) {
    const char *ret_value = NULL;
    const char *c_str = NULL;
    jstring local_string =
        J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__withCString(
...
const char *
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onSelectCodec__withCString__asCBuffer__catchAll(
    JNIEnv *env, jobject weakThiz, const char *mimeType_cstr__, jint profile,
    jint level, char *out_buf, int out_len) {
    const char *ret_value = NULL;
    const char *c_str = NULL;
...
jboolean J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onNativeInvoke(
    JNIEnv *env, jobject weakThiz, jint what, jobject args) {
...
jboolean
J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onNativeInvoke__catchAll(
    JNIEnv *env, jobject weakThiz, jint what, jobject args) {
    jboolean ret_value =
        J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer__onNativeInvoke(
            env, weakThiz, what, args);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return false;
    }
...
int J4A_loadClass__J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer(
    JNIEnv *env) {
    int ret = -1;
    ...
    class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id =
    ...
    if (class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
            .field_mNativeMediaPlayer == NULL)
        goto fail;
    ...
    class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
        ...
        J4A_GetFieldID__catchAll(env, class_id, name, sign);
    if (class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
            .field_mNativeMediaDataSource == NULL)
        goto fail;
    ...
    if (class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
            .method_postEventFromNative == NULL)
        goto fail;

    class_id = class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.id;
    name = "onSelectCodec";
    sign = "(Ljava/lang/Object;Ljava/lang/String;II)Ljava/lang/String;";
    class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer.method_onSelectCodec =
        J4A_GetStaticMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_tv_danmaku_ijk_media_player_IjkMediaPlayer
            .method_onSelectCodec == NULL)
        goto fail;
