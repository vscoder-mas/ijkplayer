...
static J4AC_android_media_PlaybackParams
    class_J4AC_android_media_PlaybackParams;

jobject J4AC_android_media_PlaybackParams__setSpeed(JNIEnv *env, jobject thiz,
                                                    jfloat speed) {
    return (*env)->CallObjectMethod(
        env, thiz, class_J4AC_android_media_PlaybackParams.method_setSpeed,
        speed);
}

jobject J4AC_android_media_PlaybackParams__setSpeed__catchAll(JNIEnv *env,
                                                              jobject thiz,
                                                              jfloat speed) {
    jobject ret_object =
        J4AC_android_media_PlaybackParams__setSpeed(env, thiz, speed);
...
jobject J4AC_android_media_PlaybackParams__setSpeed__asGlobalRef__catchAll(
    JNIEnv *env, jobject thiz, jfloat speed) {
    jobject ret_object = NULL;
    jobject local_object =
        J4AC_android_media_PlaybackParams__setSpeed__catchAll(env, thiz, speed);
...
int J4A_loadClass__J4AC_android_media_PlaybackParams(JNIEnv *env) {
    ...
    if (class_J4AC_android_media_PlaybackParams.id != NULL) return 0;
    ...
    class_J4AC_android_media_PlaybackParams.id =
        J4A_FindClass__asGlobalRef__catchAll(env, sign);
    if (class_J4AC_android_media_PlaybackParams.id == NULL) goto fail;

    class_id = class_J4AC_android_media_PlaybackParams.id;
    name = "setSpeed";
    sign = "(F)Landroid/media/PlaybackParams;";
    class_J4AC_android_media_PlaybackParams.method_setSpeed =
